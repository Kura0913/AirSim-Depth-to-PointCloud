...
class SavePointCloudByLidar:
    ...
    def start_save_point_cloud(self, parameters):
        drone_id = self.set_drone_info(parameters)
        point_cloud_list = []
        drone_position = []
        drone_quaternion = []
        ...
        for lidar_face, point_cloud_dict in parameters['lidar']:
            ...
            point_cloud_list = [point_cloud_dict[idx] for idx in range(len(point_cloud_dict))]

            point_cloud_matrix = self.generate_point_cloud(self, point_cloud_list)
            ...
            point_cloud_list += point_cloud_info
